...
The complete manual page of the original Bash implementation, the one `git ftp help` and `man git-ftp` show.

!!! info "Synced from upstream"

    This page is generated from [its source](https://github.com/git-ftp/git-ftp/blob/master/man/git-ftp.1.md)
